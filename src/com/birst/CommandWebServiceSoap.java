...
public interface CommandWebServiceSoap {
    ...
    public String generateBirstConnectToken(
    ...
    public String registerBirstConnectAgent(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            ...
            @WebParam(name = "description", targetNamespace = "http://www.birst.com/")
                    String description,
            @WebParam(name = "userId", targetNamespace = "http://www.birst.com/")
                    String userId,
            @WebParam(name = "restricted", targetNamespace = "http://www.birst.com/")
                    boolean restricted);

    /**
     * Update an existing birst connect agent. Arguments are Login token, agent ID, new agent name and new agent description and returns true if successful.
     * 
     * @param agentId
     * @param name
     * @param description
     ...
     *     returns boolean
     */
    @WebMethod(action = "http://www.birst.com/updateBirstConnectAgent")
    @WebResult(name = "updateBirstConnectAgentResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "updateBirstConnectAgent", targetNamespace = "http://www.birst.com/", className = "com.birst.UpdateBirstConnectAgent")
    @ResponseWrapper(localName = "updateBirstConnectAgentResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.UpdateBirstConnectAgentResponse")
    public boolean updateBirstConnectAgent(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "agentId", targetNamespace = "http://www.birst.com/")
                    String agentId,
            @WebParam(name = "name", targetNamespace = "http://www.birst.com/")
                    String name,
            @WebParam(name = "description", targetNamespace = "http://www.birst.com/")
    ...
    /**
     * Delete an existing birst connect agent. Arguments are Login token and agent ID and returns true if successful.
     * 
     * @param agentId
     * @param token
     * @return
     *     returns boolean
     */
    @WebMethod(action = "http://www.birst.com/deleteBirstConnectAgent")
    @WebResult(name = "deleteBirstConnectAgentResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "deleteBirstConnectAgent", targetNamespace = "http://www.birst.com/", className = "com.birst.DeleteBirstConnectAgent")
    @ResponseWrapper(localName = "deleteBirstConnectAgentResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.DeleteBirstConnectAgentResponse")
    public boolean deleteBirstConnectAgent(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "agentId", targetNamespace = "http://www.birst.com/")
                    String agentId);
    ...
    /**
     * Get health status of agents. Arguments are agent IDs and returns agent status.
     * 
     * @param agentIds
     * @param token
     * @return
     *     returns com.birst.ArrayOfAgentStatus
     */
    @WebMethod(action = "http://www.birst.com/getAgentHealth")
    @WebResult(name = "getAgentHealthResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "getAgentHealth", targetNamespace = "http://www.birst.com/", className = "com.birst.GetAgentHealth")
    @ResponseWrapper(localName = "getAgentHealthResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.GetAgentHealthResponse")
    public ArrayOfAgentStatus getAgentHealth(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "agentIds", targetNamespace = "http://www.birst.com/")
                    ArrayOfString agentIds);

    /**
     * Upgrade an existing birst connect agent. Arguments are Login token and agent IDs and returns true if successful.
     * 
     * @param agentIds
     * @param token
     * @return
     *     returns boolean
     */
    @WebMethod(action = "http://www.birst.com/upgradeAgent")
    @WebResult(name = "upgradeAgentResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "upgradeAgent", targetNamespace = "http://www.birst.com/", className = "com.birst.UpgradeAgent")
    @ResponseWrapper(localName = "upgradeAgentResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.UpgradeAgentResponse")
    ...
    /**
     * Import a package into the space. Arguments are the Login token, spaceFrom Id (parent space Id), package name, spaceTo Id (child space Id).
     * 
     * @param spaceFromID
     * @param spaceToID
     * @param packageName
    ...
    public ArrayOfString importPackage(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceFromID", targetNamespace = "http://www.birst.com/")
                    String spaceFromID,
            @WebParam(name = "packageName", targetNamespace = "http://www.birst.com/")
                    String packageName,
            @WebParam(name = "spaceToID", targetNamespace = "http://www.birst.com/")
                    String spaceToID);

    /**
     * Repoints packages in a space. Arguments are the Login token, childSpace Id, oldParentSpace Id, newParentSpace Id
     * 
     * @param existingParentSpaceId
     * @param newParentSpaceId
     * @param childSpaceId
     * @param token
     */
    @WebMethod(action = "http://www.birst.com/repointPackages")
    @RequestWrapper(localName = "repointPackages", targetNamespace = "http://www.birst.com/", className = "com.birst.RepointPackages")
    @ResponseWrapper(localName = "repointPackagesResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.RepointPackagesResponse")
    public void repointPackages(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "childSpaceId", targetNamespace = "http://www.birst.com/")
                    String childSpaceId,
            @WebParam(name = "existingParentSpaceId", targetNamespace = "http://www.birst.com/")
                    String existingParentSpaceId,
            @WebParam(name = "newParentSpaceId", targetNamespace = "http://www.birst.com/")
                    String newParentSpaceId);
    ...
    public void setSpaceProperties(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
    ...
    /**
     * Copy the settings from one account into another.  The arguments are the Login token, the account Id to copy from, the account Id to copy to, and a command separated list of settings to copy.
     * 
     * @param accountToID
     * @param accountFromID
     * @param options
     * @param token
     */
    @WebMethod(action = "http://www.birst.com/copyAccountSettings")
    @RequestWrapper(localName = "copyAccountSettings", targetNamespace = "http://www.birst.com/", className = "com.birst.CopyAccountSettings")
    @ResponseWrapper(localName = "copyAccountSettingsResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.CopyAccountSettingsResponse")
    public void copyAccountSettings(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "accountFromID", targetNamespace = "http://www.birst.com/")
                    String accountFromID,
            @WebParam(name = "accountToID", targetNamespace = "http://www.birst.com/")
                    String accountToID,
            @WebParam(name = "options", targetNamespace = "http://www.birst.com/")
                    String options);

    /**
     * Copy the workflow from one account into another. The arguments are the Login token, the source account ID, the workflow ID to copy from, the target account ID, the owner ID of the new workflow in target account, the space ID mapping for workflow task parameters, the user ID mapping for workflow task parameters
     * 
     * @param fromWorkflowId
     * @param workflowOwnerId
     * @param spaceIdMapping
     * @param fromAccountId
     * @param userIdMapping
     * @param toAccountId
     * @param token
     ...
     *     returns java.lang.String
     */
    @WebMethod(action = "http://www.birst.com/copyWorkflow")
    @WebResult(name = "copyWorkflowResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "copyWorkflow", targetNamespace = "http://www.birst.com/", className = "com.birst.CopyWorkflow")
    @ResponseWrapper(localName = "copyWorkflowResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.CopyWorkflowResponse")
    public String copyWorkflow(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "fromAccountId", targetNamespace = "http://www.birst.com/")
                    String fromAccountId,
            @WebParam(name = "fromWorkflowId", targetNamespace = "http://www.birst.com/")
                    String fromWorkflowId,
            @WebParam(name = "toAccountId", targetNamespace = "http://www.birst.com/")
                    String toAccountId,
            @WebParam(name = "workflowOwnerId", targetNamespace = "http://www.birst.com/")
                    String workflowOwnerId,
            @WebParam(name = "spaceIdMapping", targetNamespace = "http://www.birst.com/")
                    ArrayOfSpaceIdMapping spaceIdMapping,
            @WebParam(name = "userIdMapping", targetNamespace = "http://www.birst.com/")
                    ArrayOfUserIdMapping userIdMapping);
    ...
    /**
     * Add a create mask (regular expression) to a user. Arguments are the Login token, the name of the accountadmin user and the mask which is used to validate email when creating a user.
     * 
     * @param userName
     * @param token
     * @param mask
     */
    @WebMethod(action = "http://www.birst.com/addMask")
    @RequestWrapper(localName = "addMask", targetNamespace = "http://www.birst.com/", className = "com.birst.AddMask")
    @ResponseWrapper(localName = "addMaskResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.AddMaskResponse")
    public void addMask(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "userName", targetNamespace = "http://www.birst.com/")
                    String userName,
            @WebParam(name = "mask", targetNamespace = "http://www.birst.com/")
                    String mask);
    ...
    public ArrayOfUserSpace listAllSpaces(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token);
     ...
     *     returns java.lang.String
     */
    @WebMethod(action = "http://www.birst.com/addCloudConnection")
    @WebResult(name = "addCloudConnectionResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "addCloudConnection", targetNamespace = "http://www.birst.com/", className = "com.birst.AddCloudConnection")
    @ResponseWrapper(localName = "addCloudConnectionResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.AddCloudConnectionResponse")
    public String addCloudConnection(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
            @WebParam(name = "accountID", targetNamespace = "http://www.birst.com/")
                    String accountID,
            @WebParam(name = "cloudConnection", targetNamespace = "http://www.birst.com/")
                    CloudCon cloudConnection);

    /**
     * Update cloud connection. Arguments are Login token, space id, connection id and cloud connection.
     * 
     * @param spaceID
     * @param accountID
     * @param cloudConnection
     ...
     * @param token
     */
    @WebMethod(action = "http://www.birst.com/updateCloudConnection")
    @RequestWrapper(localName = "updateCloudConnection", targetNamespace = "http://www.birst.com/", className = "com.birst.UpdateCloudConnection")
    @ResponseWrapper(localName = "updateCloudConnectionResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.UpdateCloudConnectionResponse")
    public void updateCloudConnection(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
            @WebParam(name = "accountID", targetNamespace = "http://www.birst.com/")
                    String accountID,
            @WebParam(name = "connectionId", targetNamespace = "http://www.birst.com/")
                    String connectionId,
            @WebParam(name = "cloudConnection", targetNamespace = "http://www.birst.com/")
                    CloudCon cloudConnection);

    /**
     * Delete cloud connection. Arguments are Login token, space id and connection id.
     * 
     * @param spaceID
     * @param accountID
     * @param connectionId
     * @param token
     */
    @WebMethod(action = "http://www.birst.com/deleteCloudConnection")
    @RequestWrapper(localName = "deleteCloudConnection", targetNamespace = "http://www.birst.com/", className = "com.birst.DeleteCloudConnection")
    @ResponseWrapper(localName = "deleteCloudConnectionResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.DeleteCloudConnectionResponse")
    public void deleteCloudConnection(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
     ...
     * @param token
     * @return
     *     returns com.birst.ArrayOfCloudCon
     */
    @WebMethod(action = "http://www.birst.com/listCloudConnections")
    @WebResult(name = "listCloudConnectionsResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "listCloudConnections", targetNamespace = "http://www.birst.com/", className = "com.birst.ListCloudConnections")
    @ResponseWrapper(localName = "listCloudConnectionsResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.ListCloudConnectionsResponse")
    public ArrayOfCloudCon listCloudConnections(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
     ...
     * 
     * @param spaceID
     * @param connectionAgentsMappings
     * @param token
     */
    @WebMethod(action = "http://www.birst.com/mapAgentsToConnections")
    @RequestWrapper(localName = "mapAgentsToConnections", targetNamespace = "http://www.birst.com/", className = "com.birst.MapAgentsToConnections")
    @ResponseWrapper(localName = "mapAgentsToConnectionsResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.MapAgentsToConnectionsResponse")
    public void mapAgentsToConnections(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "spaceID", targetNamespace = "http://www.birst.com/")
                    String spaceID,
            @WebParam(name = "connectionAgentsMappings", targetNamespace = "http://www.birst.com/")
                    ArrayOfConnectionAgentsMapping connectionAgentsMappings);
     ...
     * @param token
     * @return
     *     returns com.birst.ArrayOfConnectionAgentsMappingResult
     */
    @WebMethod(action = "http://www.birst.com/setAgentsToConnectionMapping")
    @WebResult(name = "setAgentsToConnectionMappingResult", targetNamespace = "http://www.birst.com/")
    @RequestWrapper(localName = "setAgentsToConnectionMapping", targetNamespace = "http://www.birst.com/", className = "com.birst.SetAgentsToConnectionMapping")
    @ResponseWrapper(localName = "setAgentsToConnectionMappingResponse", targetNamespace = "http://www.birst.com/", className = "com.birst.SetAgentsToConnectionMappingResponse")
    public ArrayOfConnectionAgentsMappingResult setAgentsToConnectionMapping(
            @WebParam(name = "token", targetNamespace = "http://www.birst.com/")
                    String token,
            @WebParam(name = "connectionAgentsMappings", targetNamespace = "http://www.birst.com/")
                    ArrayOfConnectionAgentsMapping connectionAgentsMappings);
